...
.. code-block:: bash
   ...
   opm-vis-mpl tests/data/SPE1CASE1 -K SGAS -k 1 --animate --save sgas.gif
   opm-vis-mpl tests/data/SPE1CASE1 -K SGAS -k 1 -r 0:120:10 --animate --save sgas.gif
...
.. code-block:: bash
   ...
   opm-vis-mpl tests/data/SPE1CASE1 -K SGAS -k 1 --animate --fps 4 --save sgas.gif
