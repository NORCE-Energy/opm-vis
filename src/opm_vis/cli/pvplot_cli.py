...
def main(
    ...
    not compatible with --grid-only). It combines with --diff: the aggregate is computed
    separately at --rstep and at --diff-rstep, and --diff differences the two aggregates.
